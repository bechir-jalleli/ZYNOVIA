...
const StatCard: React.FC<StatCardProps> = ({
  ...
  <motion.div
    ...
    className='group rounded-2xl bg-white/70 p-4 shadow-md shadow-black/5 ring-1 ring-white/60 backdrop-blur-xl dark:bg-slate-900/70 dark:ring-white/5'>
    <p className='text-xs font-medium uppercase tracking-[0.22em] text-primary/80'>
      {label}
    </p>
    <p className='mt-2 text-3xl font-semibold text-[#0A004B] dark:text-white'>
    ...
    <section
      ...
      <div className='container mx-auto max-w-6xl space-y-16 px-4 sm:px-6 lg:px-8'>
        ...
        <motion.header
          ...
          <div className='space-y-5 text-center md:text-left'>
            ...
            <div className='mx-auto max-w-3xl space-y-3 text-sm sm:text-base text-slate-700 dark:text-slate-300'>
              ...
              <div className='mt-4 rounded-2xl border border-primary/10 bg-white/80 p-4 shadow-[0_18px_45px_rgba(15,23,42,0.12)] backdrop-blur-sm dark:border-white/5 dark:bg-slate-900/70'>
                <p className='mb-3 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.25em] text-primary/80 dark:text-cyan-300'>
                  Nous construisons un pont solide entre
                </p>

                <ul className='mt-1 grid gap-2 text-left text-xs sm:grid-cols-2 sm:text-sm'>
                  <li className='flex items-start gap-2'>
                    <span className='mt-1 h-2 w-2 rounded-full bg-gradient-to-br from-[#00C3D9] via-[#0091E6] to-[#0067E0]' />
                    <span>Le système scolaire et ses limites actuelles</span>
                  </li>
                  <li className='flex items-start gap-2'>
                    <span className='mt-1 h-2 w-2 rounded-full bg-gradient-to-br from-[#00C3D9] via-[#0091E6] to-[#0067E0]' />
                    <span>Les innovations technologiques qui redéfinissent les compétences</span>
                  </li>
                  <li className='flex items-start gap-2'>
                    <span className='mt-1 h-2 w-2 rounded-full bg-gradient-to-br from-[#00C3D9] via-[#0091E6] to-[#0067E0]' />
                    <span>Les besoins réels et évolutifs du marché de l’emploi</span>
                  </li>
                  <li className='flex items-start gap-2'>
                    <span className='mt-1 h-2 w-2 rounded-full bg-gradient-to-br from-[#00C3D9] via-[#0091E6] to-[#0067E0]' />
                    <span>Les attentes concrètes des parents et des entreprises</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <motion.section
          {...fadeInUp}
          transition={{ duration: 0.6, ease: 'easeOut' }}
          className='grid gap-8 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] lg:items-center'>
          <div className='space-y-4 text-sm sm:text-base text-slate-700 dark:text-slate-200'>
            ...
            <p>
              ...
              attentes du marché. Le graphique ci‑contre illustre cette évolution et montre pourquoi il est
              essentiel de préparer dès aujourd’hui les élèves à ce futur.
            </p>
            <div className='grid gap-4 sm:grid-cols-3'>
              <StatCard
                label='Emplois transformés'
                value={40}
                suffix='%'
                description="des emplois mondiaux seront impactés par l'IA d'ici 2030."
                source='FMI, janvier 2024'
              />
              <StatCard
                label='Métiers à inventer'
                value={85}
                suffix='%'
                description="des métiers de demain n'existent pas encore aujourd'hui."
                source='Adecco Group & Dell, WEF 2021'
              />
              <StatCard
                label='Entreprises IA'
                value={70}
                suffix='%'
                description="des entreprises investiront massivement dans l’IA."
