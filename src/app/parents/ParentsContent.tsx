...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
          'Non, ce n’est pas nécessaire. Les parcours sont organisés par niveaux, avec une progression claire et un accompagnement étape par étape.',
  },
  {
    question: 'Comment accompagnez-vous les parents ?',
    answer:
          'Les parents sont informés grâce à des bilans réguliers, des retours personnalisés, des démos de projets et des temps d’échanges dédiés.',
  },
  {
...
const ParentsContent = () => {
  ...
  return (
    <main className='bg-gradient-to-b from-secondary/20 via-secondary/5 to-transparent dark:from-slate-950 dark:via-slate-900 dark:to-slate-950'>
          ...
          >
            <div className='space-y-5 md:text-left'>
              ...
              <h1 className='text-3xl font-bold leading-tight text-[#0A004B] sm:text-4xl lg:text-5xl dark:text-white'>
                Parents, vous avez un rôle clé dans l’avenir de votre enfant
              </h1>
              ...
              <div className='mt-4 flex flex-wrap items-center justify-center gap-4 text-xs text-slate-500 md:justify-start dark:text-slate-300'>
                <div className='inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 shadow-sm backdrop-blur dark:bg-slate-900/70'>
                  ...
                  <span>Accompagnement dédié aux familles, pas seulement aux élèves</span>
                </div>
                <div className='inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 shadow-sm backdrop-blur dark:bg-slate-900/70'>
            ...
            >
              ...
              <div className='relative overflow-hidden rounded-2xl'>
                <Image
                  ...
                  alt="Un parent accompagne son enfant dans l'utilisation des outils numériques."
                  width={640}
                  height={400}
      ...
      <section className='py-24 lg:py-32'>
        <div className='container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
          ...
          >
            {[
              {
                title: 'Un apprentissage moderne, utile et motivant, adapté à son âge',
                icon: Sparkles,
              },
              {
                title: 'Un impact visible sur les résultats scolaires et la motivation',
                icon: LineChart,
              },
              {
                title: 'Une montée en confiance, en autonomie et en prise de parole',
                icon: Star,
              },
              {
              ...
              {
                title: 'Un environnement sûr, valorisant et inspirant, pensé pour les jeunes',
                icon: ShieldCheck,
              },
      ...
      {/* SECTION – Ce que recherchent les parents */}
      <section className='py-24 lg:py-32'>
        <div className='container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
          <motion.div
            {...fadeInUp}
          ...
          >
            ...
            <h2 className='mt-3 text-2xl font-semibold text-[#0A004B] sm:text-3xl dark:text-white'>
              Ce que vous voulez vraiment pour votre enfant
            </h2>
            <p className='mt-3 max-w-2xl text-sm sm:text-base text-slate-700 dark:text-slate-300'>
              Au-delà des outils et des technologies, les parents cherchent une chose simple&nbsp;: que leur enfant
              progresse, se sente bien et prépare sereinement son avenir.
            </p>
          </motion.div>
          ...
          >
            <div className='space-y-4 text-sm text-slate-700 sm:text-base dark:text-slate-200'>
              <p>
                Un apprentissage sérieux mais motivant, qui aide à la fois pour l’école et pour les passions de votre
                enfant.
              </p>
              <p>
                Une équipe de confiance, capable de transformer l’IA en projets concrets, sécurisés et utiles pour son
                futur.
              </p>
            </div>

            <div className='mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 text-xs sm:text-sm text-slate-700 dark:text-slate-200'>
              <div className='rounded-2xl bg-slate-50/90 p-4 ring-1 ring-slate-100/90 shadow-sm shadow-slate-900/5 dark:bg-slate-900/80 dark:ring-slate-700/70'>
      ...
      <section className='py-24 lg:py-32'>
        <div className='container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <h2 className='mt-3 text-2xl font-semibold text-[#0A004B] sm:text-3xl dark:text-white'>
              Des compétences concrètes, étape par étape, pour l’école et pour demain
            </h2>
          </motion.div>
          ...
          <motion.div
            ...
            className='mt-8 rounded-3xl bg-white/95 p-6 shadow-[0_18px_45px_rgba(15,23,42,0.12)] ring-1 ring-slate-200/80 backdrop-blur dark:bg-slate-900/95 dark:ring-slate-700/80'
          >
            <div className='grid grid-cols-1 gap-5 md:grid-cols-2 text-xs sm:text-sm text-slate-700 dark:text-slate-200'>
              <div className='space-y-3'>
                <h3 className='text-sm font-semibold text-[#0A004B] dark:text-white'>
                  Dès le collège (11–14 ans)
                </h3>
                {[
                  'Développer logique, analyse et esprit critique',
                  'Comprendre les bases de l’IA et des algorithmes',
                  'Utiliser l’IA de manière responsable dans son quotidien scolaire',
                ].map((item, index) => (
                  <div
                    key={item}
                  ...
                  >
                    <div className='mt-0.5 flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#00C3D9]/15 via-[#0091E6]/20 to-[#0067E0]/15 text-primary dark:text-cyan-300'>
                      {index % 2 === 0 ? <Brain className='h-4 w-4' /> : <Lightbulb className='h-4 w-4' />}
                    </div>
                    <span>{item}</span>
                  </div>
                ))}
              ...
              <div className='space-y-3'>
                <h3 className='text-sm font-semibold text-[#0A004B] dark:text-white'>
                  Au lycée et au-delà (15–18 ans)
                </h3>
                {[
                  'Créer des mini-projets technologiques concrets (chatbots, automatisations, prototypes)',
                  'Collaborer efficacement en équipe sur des projets numériques',
                  'Présenter un projet devant un jury ou une classe, avec des supports clairs',
                ].map((item, index) => (
                  <div
                    key={item}
                    className='flex items-start gap-3 rounded-2xl bg-slate-50/90 px-3 py-3 ring-1 ring-slate-100/90 shadow-sm shadow-slate-900/5 dark:bg-slate-900/80 dark:ring-slate-700/70'
            ...
            <div className='mt-6 flex flex-wrap items-center justify-center gap-4 md:justify-start'>
              ...
              >
                Découvrir les programmes adaptés à son âge
              </Link>
            </div>
          </motion.div>
        </div>
        ...
        <div className='container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
          ...
          >
            {[
              ...
              '95 % des parents constatent un gain de confiance',
              '90 % des élèves souhaitent poursuivre dans la tech',
              '99% de satisfaction globale',
            ].map((label) => (
              <motion.div
                key={label}
                variants={cardVariant}
          ...
          >
            <div className='m-0 rounded-3xl bg-white/95 p-6 text-sm text-slate-700 shadow-[0_18px_45px_rgba(15,23,42,0.10)] ring-1 ring-slate-200/80 backdrop-blur dark:bg-slate-900/95 dark:text-slate-200 dark:ring-slate-700/70'>
              <div className='mb-4 flex items-center gap-4'>
                <div className='relative h-12 w-12 overflow-hidden rounded-full bg-slate-200 ring-2 ring-primary/30 dark:bg-slate-800'>
                  {/* Generic parent avatar; replace src if you have a specific image */}
                  <Image
                    src='/images/review/daniel.webp'
                    alt='Parent témoignage'
                    fill
                    sizes='48px'
                ...
                <div>
                  <h6 className='text-base font-semibold text-slate-900 dark:text-slate-50'>Maman de Sami, 4e</h6>
                  <p className='text-xs font-medium text-primary dark:text-cyan-300'>Parent d&apos;élève – Collège</p>
            ...
            <div className='m-0 rounded-3xl bg-white/95 p-6 text-sm text-slate-700 shadow-[0_18px_45px_rgba(15,23,42,0.10)] ring-1 ring-slate-200/80 backdrop-blur dark:bg-slate-900/95 dark:text-slate-200 dark:ring-slate-700/70'>
              <div className='mb-4 flex items-center gap-4'>
                ...
                <div>
                  <h6 className='text-base font-semibold text-slate-900 dark:text-slate-50'>Papa de Lina, Terminale</h6>
                  <p className='text-xs font-medium text-primary dark:text-cyan-300'>Parent d&apos;élève – Lycée</p>
                  <div className='mt-1 flex items-center gap-0.5 text-amber-500'>
                    <Star className='h-4 w-4 fill-amber-400' />
                    <Star className='h-4 w-4 fill-amber-400' />
                    <Star className='h-4 w-4 fill-amber-400' />
              ...
              <p className='text-sm leading-relaxed text-slate-700 dark:text-slate-200'>
                « Ma fille en terminale a découvert des métiers qu’elle ne connaissait pas et a pu présenter un projet
                d’IA lors d’un oral. Cela l’a beaucoup aidée pour son orientation. »
              </p>
            </div>
          </motion.div>
      ...
      <section>
        <div className='container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
          ...
          >
            {[
              {
                title: 'Transparence — Rapports réguliers et suivi des progrès faciles à comprendre',
                icon: LineChart,
              },
              {
                title: 'Sécurité — Un cadre bienveillant, responsable et encadré',
                icon: ShieldCheck,
              },
              {
                title: 'Orientation — Conseils concrets pour les filières STEM, concours et études supérieures',
                icon: HeartHandshake,
              },
            ].map(({ title, icon: Icon }) => (
              <motion.div
